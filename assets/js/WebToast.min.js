...
const LoadingToast=function(status,message){
  ...
  data= $('<div class="toastContainer"><div  class="Loader webToast"><div class="toastIcon" style="background:transparent"><div class="loader"></div> </div><div class="toastContent"><p class="toastStatus">'+ status +'</p><p class="toastMessage">'+message+'</p></div></div></div>');
...
const ConfirmToast=function(message){
  ...
  data= $('<div class="toastContainer ConfirmConainer"><div  class="webToast toastConfirm"><div class="toastContent"><p class="toastMessage">'+message+'</p><button data-confirm> Confirm </button><button data-cancel> Cancel </button></div> </div></div>');
